fprintf('Creating sorting key: MultiEmitter\n')
...
% Pjtotal = [Pj 1-Pj];
J = ones(length(imat1a),1);
jmat0 = [1 0];
filler = [1 1];
jmat0 = J*jmat0;
jmat0 = reshape(jmat0',[],1);
...
jmat1 = reshape(jmat1',[],1);
jmat2 = reshape(jmat2',[],1);
jmat3 = reshape(jmat3',[],1);
jmat4 = reshape(jmat4',[],1);
...
jmat1a = reshape(jmat1a',[],1);
jmat2a = reshape(jmat2a',[],1);
jmat3a = reshape(jmat3a',[],1);
jmat4a = reshape(jmat4a',[],1);
jmat1b = reshape(jmat1b',[],1);
jmat2b = reshape(jmat2b',[],1);
jmat3b = reshape(jmat3b',[],1);
jmat4b = reshape(jmat4b',[],1);
...
jmat1a = jmat1a*filler;
jmat2a = jmat2a*filler;
jmat3a = jmat3a*filler;
jmat4a = jmat4a*filler;
jmat1b = jmat1b*filler;
jmat2b = jmat2b*filler;
jmat3b = jmat3b*filler;
jmat4b = jmat4b*filler;
jmat1a = reshape(jmat1a',[],1);
jmat2a = reshape(jmat2a',[],1);
jmat3a = reshape(jmat3a',[],1);
jmat4a = reshape(jmat4a',[],1);
...
%combine imatxx and Bxx and dxx and jmatxx
leng = length(imat1a);
c1a = ones(leng,1);
c2a = c1a;
c3a = c1a;
...
c1a = c1a.*imat1a+c1a.*Bmat1a+c1a.*d1a+c1a.*jmat1a;
c2a = c2a.*imat2a+c2a.*Bmat2a+c2a.*d2a+c2a.*jmat2a;
c3a = c3a.*imat3a+c3a.*Bmat3a+c3a.*d3a+c3a.*jmat3a;
c4a = c4a.*imat4a+c4a.*Bmat4a+c4a.*d4a+c4a.*jmat4a;
c1b = c1b.*imat1b+c1b.*Bmat1b+c1b.*d1b+c1b.*jmat1b;
c2b = c2b.*imat2b+c2b.*Bmat2b+c2b.*d2b+c2b.*jmat2b;
c3b = c3b.*imat3b+c3b.*Bmat3b+c3b.*d3b+c3b.*jmat3b;
c4b = c4b.*imat4b+c4b.*Bmat4b+c4b.*d4b+c4b.*jmat4b;
...
fprintf('Saving sort key: MultiEmitter to Library\n')
if ispc
save('Library\sortingP_idxGuide_2emitters_backgrd_dc.mat',...
